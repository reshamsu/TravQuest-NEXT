      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 py-8 lg:py-10">
        <div className="flex flex-col gap-4 md:gap-6">
          <div className="flex flex-col gap-1 text-gray-700">
            <h1 className="text-xl font-extrabold">Section 2</h1>
            <p className="text-gray-600 text-sm lg:text-base">
              Add or Update your section 2 content here!
            </p>
          </div>
          ...
          <div className="relative w-full">
            <div className="grid grid-cols-2 gap-4">
              {images.map((src, i) => (
                <div
                  key={i}
                  className="relative h-[180px] rounded-3xl w-full duration-1000 bg-gray-100"
                >
                  <Image
                    src={src}
                    alt={`Media ${i + 1}`}
        ...
        <div className="flex flex-col justify-center gap-6 md:p-4 text-gray-700">
          <div>
            <h3 className="text-xl font-bold">
              Update{" "}
              <span className="text-[#f2836f]">Section 2 Information</span>
            </h3>
          </div>
            ...
            <div className="grid grid-cols-1 gap-8 text-gray-800 w-full">
              <div className="flex flex-col gap-3 w-full">
                <label className="text-teal-600 font-bold text-sm">
                  Section 2 Tagline<span className="text-red-500">*</span>
                </label>
                <input
                  type="text"
                  placeholder="Your S2 Tagline"
              ...
              <div className="flex flex-col gap-3 w-full">
                <label className="text-teal-600 font-bold text-sm">
                  Section 2 Header<span className="text-red-500">*</span>
                </label>
                <input
                  type="text"
                  placeholder="Your S2 Header"
                  className="bg-gray-100 border border-gray-200 rounded-xl px-4 py-3"
                  required
                />
              </div>
              <div className="flex flex-col gap-3 w-full">
                ...
                <textarea
                  placeholder="Your S2 Description"
                  className="bg-gray-100 border border-gray-200 rounded-xl px-4 py-3"
                  required
                />
              </div>
