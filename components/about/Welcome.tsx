      ...
      <div className="max-w-6xl mx-auto py-16 md:py-22 grid grid-cols-1 md:grid-cols-2 gap-14 lg:gap-24 px-6 md:px-10 2xl:px-0">
        ...
        <div className="flex flex-col justify-center gap-4 md:gap-6">
          ...
          <p className="text-xs md:text-sm font-normal text-justify text-gray-600">
            The inception of <strong>The TravQuest Travel & Tourism</strong> was
            inspired to curate experiences to delight your passion for travel.
            We endeavor to go beyond your travel needs. We specialize in
            curating unforgettable journeys. Our mission is to turn your travel
            dreams into reality.
          </p>
          <p className="text-xs md:text-sm font-normal text-justify text-gray-600">
