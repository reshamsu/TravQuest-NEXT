  ...
  return (
    <div className="bg-white text-gray-900 relative">
      ...
      <div className="relative h-[74vh] w-full overflow-hidden flex items-center justify-center text-center">
        ...
        <div className="max-w-6xl mx-auto absolute inset-0 flex flex-col justify-center items-center text-center gap-6 text-white/70 pt-24 z-10 px-8 md:px-10 2xl:px-0">
