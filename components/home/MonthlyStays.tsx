...
const Corporate = () => {
  return (
    <div className="bg-linear-to-b from-[#f2836f]/10 via-[#ffffff] to-[#ffffff]">
      <div className="max-w-6xl mx-auto py-4 md:p-10 px-6 md:px-10 2xl:px-0 grid grid-cols-1 lg:grid-cols-2">
        {/* CONTENT */}
        <div className="max-w-4xl my-10 lg:-mr-30 bg-white p-6.5 md:px-14 shadow-xl border-2 border-gray-100 rounded-4xl flex flex-col justify-center gap-4 relative z-30">
        ...
        {/* IMAGE */}
        <div className="relative h-[44vh] lg:h-[64vh] rounded-r-full w-full transition-all duration-1000 bg-gray-100">
          <Image
            ...
            priority
          />
          <div className="absolute inset-0 bg-white/15 hover:bg-black/15 rounded-r-full transition-all duration-700" />
        </div>
      </div>
    </div>
  );
