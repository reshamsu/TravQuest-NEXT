  ...
  return (
    <div className="bg-linear-to-b from-[#ffffff] via-[#ffffff] to-[#f2836f]/10">
      <div className="max-w-6xl mx-auto py-4 md:py-8 px-6 md:px-10 2xl:px-0">
        ...
        <div className="max-w-4xl mx-4 md:ml-20 -mt-20 bg-white p-6.5 md:p-10 hover:scale-105 duration-1000 shadow-xl border-2 border-gray-100 rounded-3xl flex flex-col items-center text-center md:items-start md:text-start justify-center gap-4 relative">
